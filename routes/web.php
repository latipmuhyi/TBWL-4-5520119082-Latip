...
use App\Http\Controllers\Laporan_bmasukController;
...
Route::post('admin/kelola_barang', [App\Http\Controllers\ProductController::class, 'add_product'])
    ->name('admin.product.submit')
    ->middleware('is_admin');


// Laporan Barang Masuk
Route::get('admin/laporan_bmasuk', [App\Http\Controllers\Laporan_bmasukController::class, 'index'])
    ->name('admin.laporan')
    ->middleware('is_admin');

//Route PRINT PDF
Route::get('admin/print_laporan_masuk', [App\Http\Controllers\Laporan_bmasukController::class, 'print_bmasuk'])
    ->name('admin.print.bmasuk')
    ->middleware('is_admin');
