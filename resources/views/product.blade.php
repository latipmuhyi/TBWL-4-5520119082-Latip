        ...
        <form method="post" action="{{ route('admin.product.submit') }}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="input-group mb-3">
              ...
              <input type="number" min="0" name="harga" id="harga" placeholder="Masukan Harga" class="form-control" aria-label="Amount (to the nearest dollar)">
          ...
          <div class="form-group">
            ...
            <br>
            <input type="file" class="" placeholder="Masukan Photo barang" name="photo" id="photo" />
          </div>
